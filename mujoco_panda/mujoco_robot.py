...
class MujocoRobot(object):
    ...
    def __init__(self, model_path=None, 
                            render=True, config=None, prestep_callables={}, poststep_callables={}, from_model=False):
        ...
        if isinstance(from_model,mjp.cymj.PyMjModel):
            ...
            self._model = mjp.load_model_from_path('/home/jy/junyi/3D_arm_whipping/mujoco_panda/mujoco_panda/models/self_franka_panda.xml')
        ...
        #print(self._nu,self._nq,"joint", self.qpos_joints)
        self._all_joint_names = [
            self.model.joint_id2name(j) for j in self.qpos_joints[:self._nq+1]]#self.qpos_joints
